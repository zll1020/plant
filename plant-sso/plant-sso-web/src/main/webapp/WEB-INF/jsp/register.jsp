...
<body>
	<div class="w" id="logo">
		<div>
			<a href="http://localhost:8082"> <img
				src="/images/taotao-logo.gif" alt="植物WEB信息发布系统" width="170"
				height="60" />
			</a> <b></b>
		</div>
	</div>
	...
	<div class="w" id="regist" >
		<div class="mt">
			...
			<div class="extra">
				<span>我已经注册，现在就&nbsp; <a
					href="http://localhost:8082/page/login" class="flk13">登录</a>
				</span>
			</div>
		</div>
		<div class="mc">
				...
				<div class="form" onselectstart="return false;">
						...
						<div class="item">
							...
							<div class="fl item-ifo">
								<input type="password" id="pwd" name="password" class="text"
									tabindex="2" style="ime-mode: disabled;"
									onpaste="return  false" autocomplete="off" /> <i
									class="i-pass"></i> <label id="pwd_succeed" class="blank"></label>
						...
						<div class="item" id="dphone">
							...
							<div class="fl item-ifo">
								<input type="text" id="phone" maxlength="11" name="phone"
									class="text" tabindex="4" autocomplete="off" /> <i
					...
					<div class="item item-new">
						...
						<div class="item">
							...
							<input type="button"
								 value="立即注册"
								tabindex="8" onclick="REGISTER.reg();" />
						</div>
					</div>
